    ...
    <div class="wrapper">
        ...
        <table class="tbl-full">
            ...
            <?php
                ...
                $sql = "
                    SELECT o.id AS order_id, o.order_date, o.status, o.full_name AS customer_name, o.phone AS customer_contact, o.email AS customer_email, o.address AS customer_address,
                           od.food_name, od.price, od.qty, (od.qty * od.price) AS total
                    FROM tbl_orders o
